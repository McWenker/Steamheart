...
public abstract class BaseAbilityEffect : MonoBehaviour
{
    ...
    public const string GetWeaponPowerNotification = "BaseAbilityEffect.GetWeaponPowerNotification";
    public const string GetAbilityPowerNotification = "BaseAbilityEffect.GetAbilityPowerNotification";
    public const string GetPotencyNotification = "BaseAbilityEffect.GetPotencyNotification";
